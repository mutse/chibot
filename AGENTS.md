...
- `ClaudeService`: Integrates Anthropic Codex models with streaming support
...
- **Anthropic Codex**: Codex 3.5 Sonnet, Codex 3.5 Haiku, Codex 3 Opus with streaming support
...
- Use streaming responses where supported (OpenAI, Codex)
- Implement proper error handling for network failures
- Store API keys securely using SharedPreferences
- Support for multiple API keys (OpenAI, Codex, Gemini, etc.)
...
- Codex API supports streaming with proper event handling
