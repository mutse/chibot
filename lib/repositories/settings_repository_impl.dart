...
class SettingsRepositoryImpl extends SettingsRepository {
  ...
  Future<T?> getValue<T>(String key) async {
    try {
      ...
      logError('Failed to get setting value: $key', error: e, stackTrace: stackTrace);
  ...
  Future<void> setValue<T>(String key, T value) async {
    try {
      ...
      logError('Failed to set setting value: $key', error: e, stackTrace: stackTrace);
      if (e is ValidationException) rethrow;
      throw StorageException(
  ...
  Future<void> removeValue(String key) async {
    try {
      ...
      logError('Failed to remove setting: $key', error: e, stackTrace: stackTrace);
      throw StorageException(
  ...
  Future<bool> containsKey(String key) async {
    try {
      ...
      logError('Failed to check if setting exists: $key', error: e, stackTrace: stackTrace);
      throw StorageException(
  ...
  String _getApiKeyKey(String provider) {
    switch (provider.toLowerCase()) {
      ...
      case 'bing':
        return SharedPreferencesKeys.bingApiKey;
      default:
